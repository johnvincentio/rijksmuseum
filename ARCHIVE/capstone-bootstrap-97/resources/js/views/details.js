...
//TODO; add wikipedia link
    getArtistHtml_orig: function(maker) {
        var html = '<div class="artist text-left">';
        html += '<div class="col-xs-12"><p>Artist: ' + maker.name+'</p></div>';
        if (maker.nationality !== null) {
            html += '<div class="col-xs-12"><p>Nationality: '+ maker.nationality+'</p></div>';
        }

        if (maker.dateOfBirth !== null && maker.placeOfBirth !== null) {
            html += '<div class="col-xs-12"><p>Born: ' +
                maker.placeOfBirth+', ' + maker.dateOfBirth + '</p></div>';
        }
        else if (maker.dateOfBirth !== null) {
            html += '<div class="col-xs-12"><p>Born: '+ maker.dateOfBirth+'</p></div>';
        }
        else if (maker.placeOfBirth !== null) {
            html += '<div class="col-xs-12"><p>Born: '+ maker.placeOfBirth+'</p></div>';
        }

        if (maker.dateOfDeath !== null && maker.placeOfDeath !== null) {
            html += '<div class="col-xs-12"><p>Died: ' +
                maker.placeOfDeath+', ' + maker.dateOfDeath + '</p></div>';
        }
        else if (maker.dateOfDeath !== null) {
            html += '<div class="col-xs-12"><p>Died: '+ maker.dateOfDeath+'</p></div>';
        }
        else if (maker.placeOfDeath !== null) {
            html += '<div class="col-xs-12"><p>Died: '+ maker.placeOfDeath+'</p></div>';
        }
        html += '</div>';
        return html;
    },
    getArtistHtml: function(maker) {
        ...
        if (maker.dateOfBirth !== null && maker.placeOfBirth !== null) {
            html += '<p>Born: ' +
                maker.placeOfBirth+', ' + maker.dateOfBirth + '</p>';
        }
        else if (maker.dateOfBirth !== null) {
        ...
        if (maker.dateOfDeath !== null && maker.placeOfDeath !== null) {
            html += '<p>Died: ' +
                maker.placeOfDeath+', ' + maker.dateOfDeath + '</p>';
        }
        else if (maker.dateOfDeath !== null) {
